...
kubectl set image deployments/client-deployment server=kesyyyy/multi-client:$SHA
kubectl set image deployments/worker-deployment server=kesyyyy/multi-worker:$SHA